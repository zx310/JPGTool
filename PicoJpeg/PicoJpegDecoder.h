...
// - pjpeg_decode_from_file -
//
// Usage:
//  Decompresses the file and return the pointer to data
//
//  PARAMETERS
//      name:          [in]filename to which we will decode. e.g. "in.jpg"
//      width:		   [out]pointer to jpg file width
//      height:		   [out]pointer to jpg height
//      comps:		   [out]3 is RGB. 4 is RGBA. Those are the only supported values
//      pScan_type:    [out]pScan_type can be NULL, if not it'll be set to the image's pjpeg_scan_type_t.
//		reduce:		   [in] If reduce is non-zero, the image will be more quickly decoded at approximately
...
// - pjpeg_decode_from_memory -
//
// Usage:
//  Decompresses the memory and return the pointer to data
//
//  PARAMETERS
//      data:          [in]total file data to which we will decode. 
//		size:		   [in]data size
//      width:		   [out]pointer to jpg file width
//      height:		   [out]pointer to jpg height
//      comps:		   [out]3 is RGB. 4 is RGBA. Those are the only supported values
